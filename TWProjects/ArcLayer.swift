...
//  TWProjects
//
//  Created by Pritam Hinger on 03/10/16.
...
class ArcLayer: CAShapeLayer {
    ...
    required init?(coder aDecoder: NSCoder) {
        fatalError("Arc Layer init has not been implemented")
    }
    ...
    func animate() {
        ...
        arcAnimationPre.duration = AppConstants.DurationContants.Animation
        ...
        arcAnimationLow.duration = AppConstants.DurationContants.Animation
        ...
        arcAnimationMid.duration = AppConstants.DurationContants.Animation
        ...
        arcAnimationHigh.duration = AppConstants.DurationContants.Animation
        ...
        arcAnimationComplete.duration = AppConstants.DurationContants.Animation
